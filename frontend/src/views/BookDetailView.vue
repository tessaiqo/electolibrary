      ...
      <article class="book-detail">
        ...
        <div class="book-detail__info">
          ...
          <div class="book-detail__actions">
            <button v-if="isAdmin" class="btn-small btn-edit" @click="goEdit">
              Редактировать
            </button>
            <button
...
const PLACEHOLDER =
  'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="300" height="450"><rect fill="%23ecebe6" width="300" height="450"/><text x="50%" y="50%" font-family="monospace" font-size="18" fill="%23999" text-anchor="middle">[ no cover ]</text></svg>';
...
export default {
  ...
  return { isFavorite, toggleFav: toggle, favRemove, isAdmin }
},
  data() {
    return {
      book: null,
